...
const invokeForwarders = {
  ...
  agentOpenSkillsFolder: makeInvoker<'agentOpenSkillsFolder'>(CODING_OPEN_SKILLS_FOLDER),
  agentOpenSkillFile: makeInvoker<'agentOpenSkillFile'>(CODING_OPEN_SKILL_FILE),
  agentDeleteSkillFile: makeInvoker<'agentDeleteSkillFile'>(CODING_DELETE_SKILL_FILE),
  agentCreateSkill: makeInvoker<'agentCreateSkill'>(CODING_CREATE_SKILL),
  agentListSkillFiles: makeInvoker<'agentListSkillFiles'>(CODING_LIST_SKILL_FILES),
