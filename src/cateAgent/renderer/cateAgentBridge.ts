...
//
// agentStore funnels every CODING_EVENT whose panelId is a Cate Agent session here
// (instead of into a phantom CateAgentPanel). Two things happen:
...
//
// Kept in sync with CATE_AGENT_MARKER in src/cateAgent/extensions/cate-agent-tools/index.ts.
// =============================================================================
