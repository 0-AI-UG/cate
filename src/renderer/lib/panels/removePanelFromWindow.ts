...
//     released (PTYs keep running, mid-transfer to the other window), and
//     records dropped so the overview lists a panel iff it lives here.
//     The receive side re-adds everything via addPanel / applyCanvasChildPanels
//     when the panel is dropped back in.
//
//   reason 'close' → the panel is gone for good: PTYs killed, xterms and agent
