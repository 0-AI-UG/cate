...
export class DeferredRuntime implements Runtime {
  ...
  constructor(
    ...
    this.file = {
      ...
      harnessRoot: () => d((c) => c.file.harnessRoot()),
    ...
    this.vcs = {
      ...
      fileContent: (cwd, spec, filePath, side, access) => d((c) => c.vcs.fileContent(cwd, spec, filePath, side, access)),
      monitorStatus: (cwd, access) => d((c) => c.vcs.monitorStatus(cwd, access)),
      stage: (cwd, filePath, access) => d((c) => c.vcs.stage(cwd, filePath, access)),
      stageAll: (cwd, access) => d((c) => c.vcs.stageAll(cwd, access)),
