...
export const BROWSER_LIFECYCLE_METHODS = new Set(['getTab', 'listTabs', 'createTab', 'goto', 'back', 'forward', 'reload', 'close', 'setViewport', 'resize', 'download', 'downloads'])
...
export const BROWSER_READ_METHODS = new Set([...BROWSER_OBSERVATION_METHODS, ...BROWSER_ELEMENT_READ_METHODS, 'listTabs', 'downloads', 'waitFor'])
